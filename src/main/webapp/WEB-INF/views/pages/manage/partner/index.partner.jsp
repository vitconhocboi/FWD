                                    ...
                                    <form class="form-horizontal">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control col-sm-12"
                                                           data-bind="value:partner.partnerName.VALUE_VIEW">
                                                </div>
                                                <label class="col-sm-2">
                                                    Mã số thuế
                                                </label>
                                                <div class="col-sm-4">
                                                    <input class="form-control col-sm-12"
                                                           data-bind="value:partner.taxCode.VALUE_VIEW">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control col-sm-12"
                                                           data-bind="value:partner.contactStaff.VALUE_VIEW">
                                                </div>
                                                <label class="col-sm-2">
                                                    Nhân viên cs
                                                </label>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-4">
                                                    <input class="form-control col-sm-12"
                                                           data-bind="value:partner.businessType.VALUE_VIEW">
                                                </div>
                                                <label class="col-sm-2">
                                                    Các tuyến đi chính
                                                </label>
                                                <div class="col-sm-4">
                                                    <input class="form-control col-sm-12"
                                                           data-bind="value:partner.journey.VALUE_VIEW">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="panel-body">
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column"
                                        ...
                                        <tbody id="list-container"
                                               data-bind="foreach: { data: $root.listPartner, as: 'item'}">
                                        <tr>
                                            <td class="text-center"
                                                data-bind="text:($root.pagingVM.currentPage()-1) * $root.pagingVM.pageSize() + $index() + 1"></td>
                                            <td class="text-center" data-bind="text: item.partnerName"></td>
...
<script type="text/javascript" src="<c:url value="/app/manage/partner/index.partner.module.js"/>"
